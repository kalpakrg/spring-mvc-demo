...
public class PlaceSearchResponse {
	...
	public String toString() {
		return "PlaceSearchResponse [status=" + status + ", htmlAttribution="
				+ htmlAttribution + ", nextPageToken=" + nextPageToken
				+ ", results=" + results + "]";
	}
	...
	public static class Result {
		...
		public String toString() {
			return "Result [name=" + name + ", vicinity=" + vicinity
					+ ", rating=" + rating + ", icon=" + icon + ", reference="
					+ reference + ", id=" + id + ", openingHours="
					+ openingHours + ", photo=" + photo + ", geometry="
					+ geometry + ", placeId=" + placeId + ", scope=" + scope
					+ ", types=" + types + "]";
		}
	...
	public static class Photo {
		...
		@Override
		public String toString() {
			return "Photo [photoReference=" + photoReference + ", width="
					+ width + ", heigth=" + heigth + "]";
		}
	}
}
